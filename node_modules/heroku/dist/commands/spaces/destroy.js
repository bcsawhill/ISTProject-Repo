  ...
  `];
    ...
    async run() {
      ...
      `;
        ...
        await new ConfirmCommand().confirm(spaceName, confirm, `Destructive Action\nThis command will destroy the space ${color.space(spaceName)}\n${natWarning}\n`);
        ux.action.start(`Destroying space ${color.space(spaceName)}`);
