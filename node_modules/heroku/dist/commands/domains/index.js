...
www.example.com  CNAME            www.example.herokudns.com`];
    ...
    getFilteredDomains = (filterKeyValue, domains) => {
    ...
    mapColumnHeadersToKeys = (columnHeaders) => {
    ...
    mapSortFieldToProperty = (sortField) => {
    ...
    outputCSV = (customDomains, tableConfig, sortProperty) => {
        const getValue = (domain, key, config) => {
    ...
    tableConfig = (needsEndpoints, extended, requestedColumns) => {
        const tableConfig = {
            hostname: {
                header: 'Domain Name',
            },
    ...
    async confirmDisplayAllDomains(customDomains) {
