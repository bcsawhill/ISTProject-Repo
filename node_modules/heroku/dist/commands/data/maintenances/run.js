...
export default class DataMaintenancesRun extends BaseCommand {
    ...
    async confirmMaintenanceMode(addon, confirm, force) {
        const { body: app } = await this.heroku.get(`/apps/${addon.app.id}`);
    ...
    async run() {
        ...
        await this.dataApi.post(`/data/maintenances/v1/${addon.id}/run`, this.dataApi.defaults);
