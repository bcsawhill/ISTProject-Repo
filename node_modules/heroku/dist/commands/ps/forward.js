...
export default class Forward extends Command {
  ...
  `];
    ...
    async run() {
        ...
        const portMappings = args.port.split(',').map((portMapping) => {
        ...
        await exec.initFeature(context, this.heroku, async (configVars) => {
            await exec.createSocksProxy(context, this.heroku, configVars, (dynoIp, dynoName, socksPort) => {
