...
export class ChangelogParser {
    ...
    static async create(changelogPath) {
    ...
    static fromString(changelog) {
        return new ChangelogParser(changelog);
    }
    static getDefaultChangelogPath() {
